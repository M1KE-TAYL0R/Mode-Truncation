...
p    for [i = 2:7] "./pf-2/E-f22-n10-p20000_abs.txt" u 1:(column(i)*eV) every 4::0  w p lc "#596275" ps 1.6 pt 7  t "",\
   for [i = 2:7] "./pA/E-f18-n10-p10000_abs.txt" u 1:(column(i)*eV) w l lc "black" lw 12 t "",\
    for [i = 2:7]  "./Feist/E-f60-n18-p10000_abs.txt" u 1:(column(i)*eV) w l lc rgb "#ff6b6b" lw 5 t "", \
    for [i = 2:7] "./PF/E-f60-n18-p10000_abs.txt" u 1:(column(i)*eV) w l lc rgb "#48dbfb" lw 4 t "", \
