...
set xr [-2.5:2.5]
eV = 1 #27.2114
set yr [-0.1/27.2114:.055]
set size 1, 0.7
E0 = 0.4303
set tics font ", 14"
# set ytics 0,0.01*eV ,0.05*eV

# p   for [i = 2:8] "./pA_2mode/extra-data/E-f18-n10-η0.15.txt" u 1:(column(i)*eV) every 6::0  w p lc "#596275" ps 2 pt 7  t "",
p   for [i = 2:8] "./PF_two/E-f18-n10-η0.15.txt" u 1:(column(i)*eV) every 6::0  w p lc "#596275" ps 2 pt 7  t "",\
    for [i = 2:8] "./pA_2mode/E-f20-n19-η0.15_single.txt" u 1:(column(i)*eV) w l lc "black" lw 12 t "",\
    for [i = 2:8] "./PF_Fiest_Trunc/E-f100-n20-η0.15.txt" u 1:(column(i)*eV) w l lc rgb "#48dbfb" lw 6 t "",\
    for [i = 2:8]  "./PF_Fiest_Trunc/E-f60-n18-η0.15_Feist.txt" u 1:(column(i)*eV) w l lc rgb "#ff6b6b" lw 7 t "", \
